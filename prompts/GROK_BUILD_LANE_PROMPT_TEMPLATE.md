...
**Active Nobu implementation workflow.** Use this template for one lane at a time with Grok Build as the repository executor.
...
You are working on **Nobu** in Grok Build.
