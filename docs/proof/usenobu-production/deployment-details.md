...
| Node | 24.x |
| SSO / deployment protection on custom production host | Disabled for public access |

Product name in UI and package remains **Nobu**. Deployment identity is **UseNobu**.
