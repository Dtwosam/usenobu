...
**Production aliases:** `https://www.usenobu.xyz`, `https://usenobu.vercel.app`  
...
| Free alias re-pointed | `usenobu.vercel.app` → this deployment |
...
```http
GET|POST https://usenobu.vercel.app/v1/owner/monitor-scheduler
